...
- **Basis for the belief:** The frustration is not only forgetting tasks, but struggling to maintain execution after the first burst of motivation. The student needs a system that makes the next action feel obvious and rewarding.
- **Evidence found:**
